...
function generateForm() {
  let res = "";
  res = '<form name="Config" action="https://httpbin.org/get" method="get">';
  res += "<fieldset>";
  res += "<legend>Configure Game:</legend>";
  res +=
    '<label for="name">Name</label> <input name="Name" type="text" id="name" placeholder="Name" />';
  res +=
    '<label for="numberOfDice">Number of dice</label> <input name="Number of dice" type="number" id="numberOfDice" placeholder="6" min="1" max="100"/>';
  res +=
    '<label for="difficultySetting">Difficulty setting</label> <input name="Difficulty setting" type="number" min="1" max="2" step="0.1" id="difficultySetting" value="1"/>';
  res +=
    '<label for="playTopDown">Play top down</label> <input name="Play" type="radio" id="playTopDown" value="Play top down" checked/>';
  res +=
    '<label for="playButtomUp">Play buttom up</label> <input name="Play" type="radio" id="playButtomUp" value="Play buttom up"/>';
...
function generateHelpLinks() {
  return '<p><a href="help.html">help page</a> and<a href="https://da.wikipedia.org/wiki/Yatzy ">Yatzy game</a></p>';
}
